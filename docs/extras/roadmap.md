...
title: Roadmap / To-Do
sidebar_position: 1
description: Funciones futuras y hoja de ruta de desarrollo de l3mcore.
---

# Hoja de Ruta (To-Do)

l3mcore se encuentra en continuo desarrollo. A continuación se detallan algunas de las características y mejoras clave que tenemos planeado incorporar en futuras versiones:

## Sistema de Plugins (En progreso)
Actualmente el sistema de plugins está parcialmente implementado. Nuestro objetivo es completarlo para permitir a los desarrolladores extender la funcionalidad de l3mcore mediante *hooks* personalizados que intercepten, modifiquen o analicen las peticiones y respuestas en tiempo real, sin tocar el código fuente del núcleo.

## Gestión de VRAM
Una de las grandes mejoras planificadas es un sistema inteligente de gestión de VRAM (memoria de video) para modelos locales. La idea es que l3mcore sea capaz de:
...
*¿Tienes alguna otra idea o característica que te gustaría ver en l3mcore? ¡Abre un Issue en nuestro repositorio principal de GitHub: [lemoelink/l3mcore/issues](https://github.com/lemoelink/l3mcore/issues)!*
