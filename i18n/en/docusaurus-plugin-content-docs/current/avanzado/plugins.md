...
| [Routing Transparency](./plugin-routing-transparency) | [routing_transparency.py](https://github.com/lemoelink/plugins/blob/main/routing_transparency.py) | `after_generation` | Appends a footer showing which expert processed the query and with what confidence level. |
| [Telemetry and Dashboard](./plugin-telemetry-dashboard) | [telemetry_dashboard.py](https://github.com/lemoelink/plugins/blob/main/telemetry_dashboard.py) | `after_generation` | Starts a lightweight dashboard web UI to monitor requests, estimated tokens, latencies, and costs in real time. |
